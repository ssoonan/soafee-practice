...
/*!
 * @file VideoDataTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen.
 */

#include "VideoDataTypeObjectSupport.hpp"
...
void register_VideoData_type_identifier(
        TypeIdentifierPair& type_ids_VideoData)
{

    ReturnCode_t return_code_VideoData {eprosima::fastdds::dds::RETCODE_OK};
    return_code_VideoData =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "VideoModule::VideoData", type_ids_VideoData);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_VideoData)
    {
        StructTypeFlag struct_flags_VideoData = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_VideoData = "VideoModule::VideoData";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_VideoData;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_VideoData;
        CompleteTypeDetail detail_VideoData = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_VideoData, ann_custom_VideoData, type_name_VideoData.to_string());
        CompleteStructHeader header_VideoData;
        header_VideoData = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_VideoData);
        CompleteStructMemberSeq member_seq_VideoData;
        {
            ...
            ann_custom_VideoData.reset();
            CompleteMemberDetail detail_data = TypeObjectUtils::build_complete_member_detail(name_data, member_ann_builtin_data, ann_custom_VideoData);
            CompleteStructMember member_data = TypeObjectUtils::build_complete_struct_member(common_data, detail_data);
            TypeObjectUtils::add_complete_struct_member(member_seq_VideoData, member_data);
        }
        CompleteStructType struct_type_VideoData = TypeObjectUtils::build_complete_struct_type(struct_flags_VideoData, header_VideoData, member_seq_VideoData);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_VideoData, type_name_VideoData.to_string(), type_ids_VideoData))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "VideoModule::VideoData already registered in TypeObjectRegistry for a different type.");
        }
    }
}
